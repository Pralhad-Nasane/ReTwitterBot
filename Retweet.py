...
api = tweepy.API(auth)
Hastagfile = print(Enter your hastag which you whant to retweet for this type)
...
for tweet in tweepy.Cursor(api.search, q=('print(Hastagfile) -filter:retweets'), lang='en').items(500):
    try:
